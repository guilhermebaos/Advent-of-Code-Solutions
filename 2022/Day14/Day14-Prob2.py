# Solution for Problem 2 Day 14 of AoC 2022!
...
def sand(max_y: int, occupied: set[tuple]) -> tuple[int] | bool:
    ...
    while True:
        ...
        # Sand falls on the floor
        if not new_position or new_position[1] == max_y:
            break
...
def solution_day14_prob2(puzzle_in: list):
    # Parse the input
...
# Tests and Solution ---
print("Tests:")
print(solution_day14_prob2(test01))
print("\nSolution:")
print(solution_day14_prob2(puzzle))
