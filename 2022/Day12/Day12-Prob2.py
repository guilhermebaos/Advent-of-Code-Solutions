# Solution for Problem 2 Day 12 of AoC 2022!
...
def solution_day12_prob2(puzzle_in: list):
    # Parse the maze
    ...
    # Explore the maze starting at all places with elevation a
    mini_lens = []
    for start in starts:
        visited = set()
        paths = [[start]]
        ...
        while (not done) and (len(paths) != 0):
            ...
            for next_up in possible:
                ...
                if next_up == end:
                    ...
                    break
    return min(mini_lens)


# Tests and Solution ---
print("Tests:")
print(solution_day12_prob2(test01))
print("\nSolution:")
print(solution_day12_prob2(puzzle))
