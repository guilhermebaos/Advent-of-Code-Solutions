# Solution for Problem 1 Day 11 of AoC 2022!
...
def solution_day11_prob1(puzzle_in: list):
...
# Tests and Solution ---
print("Tests:")
print(solution_day11_prob1(test01))
print("\nSolution:")
print(solution_day11_prob1(puzzle))
