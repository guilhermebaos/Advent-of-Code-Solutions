# Solution for Problem 1 Day 7 of AoC 2022!
...
def solution_day7_prob1(puzzle_in: list):
    global memory
    reset_globals()
    ...
    # Sum all directories' sizes  with size below 100k
    total = 0
    for item in sizes:
        if sizes[item] <= 100_000:
            total += sizes[item]
...
# Tests and Solution ---
print("Tests:")
print(solution_day7_prob1(test01))
print("\nSolution:")
print(solution_day7_prob1(puzzle))
